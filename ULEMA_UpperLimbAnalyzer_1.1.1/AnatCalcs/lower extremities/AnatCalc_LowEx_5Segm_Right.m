...
function AnatCalc_LowEx_5Segm_Right

% ANATCALC_LOWEX_5SEGM_RIGHT [ BodyMech 3.06.01 ]: anatomical calculation file (template)
% INPUT
%    Input : none
% PROCESS
...
%Trunk
IJ=BODY.SEGMENT(5).AnatomicalLandmark(1).Kinematics(:,t); %incisura jugularis
PX=BODY.SEGMENT(5).AnatomicalLandmark(2).Kinematics(:,t); %processus xiphoideus
C7=BODY.SEGMENT(5).AnatomicalLandmark(3).Kinematics(:,t); %processus spinosus C7
Th8=BODY.SEGMENT(5).AnatomicalLandmark(4).Kinematics(:,t); %processus spinosus T8
...
leg_length=norm(BODY.SEGMENT(4).Cluster.PosturePose*[BODY.SEGMENT(4).AnatomicalLandmark(1).ClusterFrameCoordinates;1]-...
...
BODY.SEGMENT(1).AnatomicalFrame.KinematicsPose(:,:,t)=AnatomicalFrameDefinition('Right_Foot',[CA MI MV]);
BODY.SEGMENT(2).AnatomicalFrame.KinematicsPose(:,:,t)=AnatomicalFrameDefinition('Right_Shank',[CF TT ML MM]);
BODY.SEGMENT(3).AnatomicalFrame.KinematicsPose(:,:,t)=AnatomicalFrameDefinition('Right_Thigh',[FHR EL EM]);
BODY.SEGMENT(4).AnatomicalFrame.KinematicsPose(:,:,t)=AnatomicalFrameDefinition('Pelvis',[ASISR ASISL PSISR PSISL]);
BODY.SEGMENT(5).AnatomicalFrame.KinematicsPose(:,:,t)=AnatomicalFrameDefinition('Trunk',[IJ PX C7 Th8]);
...
BODY.SEGMENT(5).StickFigure(1).Kinematics(:,t)=IJ;
BODY.SEGMENT(5).StickFigure(2).Kinematics(:,t)=PX;
BODY.SEGMENT(5).StickFigure(3).Kinematics(:,t)=Th8;
BODY.SEGMENT(5).StickFigure(4).Kinematics(:,t)=C7;
BODY.SEGMENT(5).StickFigure(5).Kinematics(:,t)=IJ;
...
%==========================================================================
% END ### AnatCalc_LowEx_5Segm_Right ###
