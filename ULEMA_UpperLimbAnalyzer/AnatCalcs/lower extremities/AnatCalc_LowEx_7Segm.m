...
function AnatCalc_LowEx_7Segm

% ANATCALC_LOWEX_7SEGM [ BodyMech 3.06.01 ]: anatomical calculation file (template)
% INPUT
%    Input : none
% PROCESS
%   Anatomical calculation of lower leg kinematics, based on CAMARC convention (Capozzoet al. 1995). 
%   Calls function
