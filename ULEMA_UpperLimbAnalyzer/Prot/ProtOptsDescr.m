...
d{end+1,1} = 'calFile';             d{end,2} = 'kine';      d{end,3} = @isequal;            d{end,4} = [];
d{end+1,1} = 'useSepCalFiles';      d{end,2} = 'kine';      d{end,3} = @isequal;            d{end,4} = [];
d{end+1,1} = 'useSingleCalFile';    d{end,2} = 'kine';      d{end,3} = @isequal;            d{end,4} = [];
