...
% CLEARSESSIONMODEL [ BodyMech 3.06.01 ] (is identical to ClearAllButprojectmodel.m)
% Clears (global) BODY content of SessionModel and TrialFields from BODY
% INPUT
% PROCESS
%   Clears all BODY Session fields: BODYcontent of PROJECTmodel remains
% OUTPUT
