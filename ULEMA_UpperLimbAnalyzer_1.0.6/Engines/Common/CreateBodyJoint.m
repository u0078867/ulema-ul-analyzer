...
function CreateBodyJoint(JointName,JointIndex,SegmentLinks,DecompositionFormat,AngleSolution)
...
%   DecompositionFormat: eulerian; cardanian decomposition format [1st 2nd 3rd]
%    coded as X=1, Y=2, Y=3;
%   AngleSolution : 'FirstSolution' or 'SecondSolution' of the decomposion algorithm  
% PROCESS
...
% $ Ver 3.06.02 VUmc - KUL, April 2010 (Jaap Harlaar en Ellen Jaspers)
...
BODY.JOINT(JointIndex).PostureRefKinematics.AngleSolution=AngleSolution;
...
BODY.JOINT(JointIndex).AnatomyRefKinematics.AngleSolution=AngleSolution;
