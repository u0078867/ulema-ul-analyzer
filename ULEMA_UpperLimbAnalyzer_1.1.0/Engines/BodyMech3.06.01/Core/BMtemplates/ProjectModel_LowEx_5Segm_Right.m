...
% PROJECTMODEL_LOWEX_5SEGM_RIGHT [ BodyMech 3.06.01 ]: Template to create New ProjectModel 
% for 5 segments: foot, lower leg, upper leg, pelvis and trunk
% INPUT
%    Input : none
% PROCESS
...
CreateBodySegment('Trunk',5,[13 14 15]); % Segment 5
...
BODY.SEGMENT(5).AnatomicalLandmark(1).Name={'IJ'}; % incisura jugularis
BODY.SEGMENT(5).AnatomicalLandmark(2).Name={'PX'}; % processus xiphoideus
BODY.SEGMENT(5).AnatomicalLandmark(3).Name={'C7'}; % processus spinosus C7
BODY.SEGMENT(5).AnatomicalLandmark(4).Name={'Th8'}; % processus spinosus T8
...
CreateBodyJoint('Pelvis_Trunk',4,[5 4],[Z X Y]); % joint 4
...
AnatomicalCalculationFunction='AnatCalc_LowEx_5Segm_Right.m';
BODY.CONTEXT.AnatomicalCalculationFunction='AnatCalc_LowEx_5Segm_Right';

%======================================================================
% END ### ProjectModel_LowEx_5Segm_Right ###
