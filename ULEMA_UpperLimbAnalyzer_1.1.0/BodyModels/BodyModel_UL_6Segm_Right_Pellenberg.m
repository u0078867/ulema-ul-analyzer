...
MyLabelSequence{5} = 'RFA1';
MyLabelSequence{6} = 'RFA2';
MyLabelSequence{7} = 'RFA3';
MyLabelSequence{8} = 'RFA4';
...
MyLabelSequence{25} = 'REL';
MyLabelSequence{26} = 'REM';
MyLabelSequence{27} = 'RRS';
MyLabelSequence{28} = 'RUS';
MyLabelSequence{29} = 'RMC3';
MyLabelSequence{30} = 'RMCP2';
MyLabelSequence{31} = 'RMCP3';
MyLabelSequence{32} = 'RMCP5';
MyLabelSequence{33} = 'RAA';
MyLabelSequence{34} = 'RAI';
MyLabelSequence{35} = 'RTS';
MyLabelSequence{36} = 'RPC';
MyLabelSequence{37} = 'RAC';
