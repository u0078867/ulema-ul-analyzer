...
function [ok, prot1FilesList, prot2FilesList] = testMHAFilesList(prot1, prot2)

% Test if the file names in the first MHA list are the same to the ones in
